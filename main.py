...
async def create_upload_files(files: List[UploadFile] = File(...)):
    ...
    content = head_html + """
    <marquee width="525" behavior="alternate"><h1 style="color:#ffff99;font-family:Garamond">Here's Our Predictions!</h1></marquee>
...
async def main():
    content = head_html + """ 
    <marquee width="525" behavior="alternate"><h1 style="color: #ffff99 ;font-family:Garamond">Please Upload Your Scenes!</h1></marquee>
    <h3 style="font-family:Garamond">We'll Try to Predict Which of These Categories They Are:</h3><br>
    """
...
<body style="background: linear-gradient(to bottom, #ff0000 0%, #ffff99 100%);">
<center>
"""
...
def get_html_table(image_paths, names, column_labels):
    ...
    if column_labels:
        s += '<tr><th><h4 style="font-family:Garamond">' + column_labels[0] + '</h4></th><th><h4 style="font-family:Garamond">' + column_labels[1] + '</h4></th></tr>'
